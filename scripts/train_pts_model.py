import argparse
import os
os.environ['THEANO_FLAGS'] = 'floatX=float32,device=gpu1,nvcc.fastmath=True,lib.cnmem=0.85'
import sys
import importlib
...
def load_data(fname):
    ...
    X_fname = FILEPATH_CONFIG['cache']+'X_%s.npy' % fname
    y_fname = FILEPATH_CONFIG['cache']+'pts_%s.npy' % fname
